...
from .admin_views import (
    ...
    AdminOnboardingSectionListView,
    AdminOnboardingSectionDetailView,
...
urlpatterns = [
    ...
    path("onboarding/sections/", AdminOnboardingSectionListView.as_view(), name="admin-onboarding-sections"),
    path("onboarding/sections/<int:pk>/", AdminOnboardingSectionDetailView.as_view(), name="admin-onboarding-section-detail"),
