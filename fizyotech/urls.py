...
urlpatterns = [
    ...
    path("api/measurements/", PatientBodyMeasurementListView.as_view(), name="patient-measurements"),
    ...
    path("api/onboarding/questions/", OnboardingQuestionsView.as_view(), name="onboarding-questions"),
    path("api/onboarding/submit/", OnboardingSubmitView.as_view(), name="onboarding-submit"),
    path("api/log-error/", FrontendErrorLogView.as_view(), name="frontend-error-log"),
